...
export class basicModules1610359918178 implements MigrationInterface {
    name = 'basicModules1610359918178'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("CREATE TABLE `fraccionamientos` (`idFraccionamiento` int NOT NULL AUTO_INCREMENT, `nombre` varchar(100) NOT NULL, `estatus` varchar(20) NOT NULL DEFAULT 'ACTIVO', PRIMARY KEY (`idFraccionamiento`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `vendedores` (`idVendedor` int NOT NULL AUTO_INCREMENT, `nombre` varchar(80) NOT NULL, `apellidoPaterno` varchar(80) NULL, `apellidoMaterno` varchar(80) NULL, `correo` varchar(100) NULL, PRIMARY KEY (`idVendedor`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `mensualidades` (`idMensualidad` int NOT NULL AUTO_INCREMENT, `numeroMensualidad` int NOT NULL, `fechaPago` date NOT NULL, `monto` float NOT NULL, `cantidadConLetra` mediumtext NULL, `mes` varchar(255) NOT NULL, `formaPago` varchar(255) NOT NULL, `estatus` varchar(255) NOT NULL, `usuarioIdUsuario` int NULL, `terrenoIdTerreno` int NULL, PRIMARY KEY (`idMensualidad`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `terrenos` (`idTerreno` int NOT NULL AUTO_INCREMENT, `noManzana` int NOT NULL, `noLote` int NOT NULL, `superficie` float NOT NULL, `costoM2` float NOT NULL, `enganche` float NULL, `formaPagoEnganche` varchar(255) NULL, `pagoAlContado` tinyint NOT NULL DEFAULT '0', `costoTotal` float NOT NULL, `saldo` float NOT NULL, `fechaVenta` date NOT NULL, `noMensualidades` int NULL, `montoMensualidad` float NULL, `diaPagoDel` int NULL, `diaPagoAl` int NULL, `pagoDeslinde` tinyint NULL, `fechaPrimeraMensualidad` date NULL, `comentariosAdicionales` text NULL, `estatus` varchar(20) NOT NULL DEFAULT 'ACTIVO', `fraccionamientoIdFraccionamiento` int NULL, `usuarioIdUsuario` int NULL, PRIMARY KEY (`idTerreno`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `usuarios` (`idUsuario` int NOT NULL AUTO_INCREMENT, `nombre` varchar(80) NOT NULL, `apellidoPaterno` varchar(80) NULL, `apellidoMaterno` varchar(80) NULL, `calle` varchar(80) NULL, `colonia` varchar(80) NULL, `municipio` varchar(40) NULL, `codigoPostal` varchar(20) NULL, `telefonoFijo` varchar(80) NULL, `telefonoCelular` varchar(80) NULL, `correo` varchar(80) NULL, PRIMARY KEY (`idUsuario`)) ENGINE=InnoDB");
